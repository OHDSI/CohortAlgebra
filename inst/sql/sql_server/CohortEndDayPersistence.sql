DROP TABLE IF EXISTS #offset_end;

SELECT subject_id,
	cohort_start_date,
	MAX(CASE 
		WHEN DATEADD(DAY, @offset_cohort_end_date, cohort_end_date) < observation_period_end_date
			THEN DATEADD(DAY, @offset_cohort_end_date, cohort_end_date)
