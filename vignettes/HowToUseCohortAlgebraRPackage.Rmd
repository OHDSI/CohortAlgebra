...
### Example 3: Change persistence criteria for cohort.
We can change the persistence criteria for a previously instantiated cohort. Lets take this cohort as an example:
...
A new cohort will be created with cohortId who cohort end date is now different because of change in persistence critera.
